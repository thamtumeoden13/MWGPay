...
class CreditPaymentCom extends Component {
        ...
        this.props.callFetchAPI(APIHostName, APIPath, billInfo).then(apiResult => {
            if (apiResult.IsError) {
                ...
                const paymentInfo = {
                    ...
                    AmountPerCard: 0,
                    TransactionContent: 'Thu hộ/Trả góp cho hợp đồng ' + billInfo.CustomerCode,
    ...
    gotoPreviewPaymentDetail = (paymentInfo) => {
        ...
        this.props.navigation.navigate('PreviewPaymentDetail', { paymentInfo: paymentInfo, paymentKey: 10 })
    }
    ...
    render() {
        const { errors, urlImg, isLoading, dataItem,
...
const CreditPayment = connect(mapStateToProps, mapDispatchToProps)(CreditPaymentCom);
