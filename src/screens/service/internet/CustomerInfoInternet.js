...
class CustomerInfoInternetCom extends Component {
...
const CustomerInfoInternet = connect(mapStateToProps, mapDispatchToProps)(CustomerInfoInternetCom);
export default CustomerInfoInternet;
