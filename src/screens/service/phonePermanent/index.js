...
class PhonePermanentCom extends Component {
    ...
    gotoPreviewPaymentDetail = (paymentInfo) => {
        ...
        this.props.navigation.navigate('PreviewPaymentDetail', { paymentInfo: paymentInfo, paymentKey: 9 })
    }
...
const PhonePermanent = connect(mapStateToProps, mapDispatchToProps)(PhonePermanentCom);
export default PhonePermanent;
