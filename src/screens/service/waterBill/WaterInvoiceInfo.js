...
class WaterInvoiceInfoCom extends Component {
            ...
            if (cacheResult && !cacheResult.IsError) {
                ...
                setTimeout(() => {
                    this.setState({
                        ...
                        titleModalAlert: 'Lỗi lấy thông tin',
        ...
        this.props.callFetchAPI(APIHostName, APIPath, billInfo).then(apiResult => {
            if (apiResult.IsError) {
                ...
                const paymentInfo = {
                    ...
                    AmountPerCard: 0,
                    TransactionContent: 'Thu tiền nước cho hợp đồng ' + billInfo.CustomerCode,
    ...
    render() {
        const { isLoading, dataItem, urlImg, errors,
        ...
        return (
            <View style={styles.container}>
                ...
                <PaymentCustomerInfo
                    urlImg={urlImg}
                    img_help={require('@assets/img/waterLogo/nuoc-pht.jpg')}
                    dataItem={dataItem}
                    errors={errors}
...
const WaterInvoiceInfo = connect(mapStateToProps, mapDispatchToProps)(WaterInvoiceInfoCom);
export default WaterInvoiceInfo;
